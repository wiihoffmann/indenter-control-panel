...
class BasicRepeatedTestSetupWidget(QWidget):
    ...
    def __init__(self, indenter, backButtonCallback):
        ...
        super().__init__()
        loadUi(os.path.join(os.getcwd(), "interface/widgets/basicRepeatedTestControls.ui"), self)
        ...
        self.toBlank = [self.backButton, self.positionButton, self.stepRateIncButton, self.stepRateDecButton, 
                    ...
                    self.repeatCountIncButton, self.repeatCountDecButton, self.startButton]
        ...
        self.stopButton.clicked.connect(self.emergencyStop)             # stop button
    ...
    def emergencyStop(self):
        ...
        # self.testCount == int(self.repeatCountDisplay.text())
